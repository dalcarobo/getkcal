...
Estes são os arquivos do projeto **getkcal** disponível no YouTube (https://www.youtube.com/watch?v=yiDq9wUiUjc).
...
```sh
  $ git clone https://github.com/dalcarobo/getkcal.git
```
